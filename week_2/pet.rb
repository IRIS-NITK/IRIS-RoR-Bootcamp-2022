class Pet
  ...
  def habitat
    HABITATS.each do |habitat,animal_id| # TODO
      if animal_id.include?(@animal_type_id)
        return habitat
      end
    end
  end
  ...
  def food_required(days)
    return @food_consumed_per_day * days # TODO
  end
  ...
  def food_cost(days)
    return food_cost_per_day * days # TODO
  end
